...
public enum CmdValue {
	...
	CONF_VIDEO("AT*CONFIG=%1$d,\"video:video_channel\",\"0\""), /**/
	...
	private CmdValue(String command, boolean onlyCounterNeeded) {
		this.command = command;
		this.onlyCounterNeeded = onlyCounterNeeded;
	}

	private CmdValue(String command) {
		this(command, false);
	}
	...
	public String with(long counter) {
		return String.format(command, counter);
	}
}
